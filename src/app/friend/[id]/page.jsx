...
const CardDetails = ({ params }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const foundFriend = friends.find((f) => f.id === parseInt(resolvedParams.id));
    ...
    return (
        <div className="w-[95%] lg:w-[80%] mx-auto my-11  ">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-4 space-y-4">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden text-sm font-medium">
                        <button className="w-full flex items-center justify-center gap-2 py-4 border-b border-gray-300 text-gray-700 shadow ">
                            <Clock size={16} /> Snooze 2 Weeks
                        </button>
                        <button className="w-full flex items-center justify-center gap-2 py-4 border-b border-gray-300 text-gray-700 shadow">
                            <Archive size={16} /> Archive
                        </button>
                        <button className="w-full flex items-center justify-center gap-2 py-4 text-red-500 shadow border-gray-300">
